# Experiment Report: canonical_ml_showcase_v8
...
![Cross Asset Volatility](../figures/canonical_ml_showcase_v8/cross_asset_volatility.png)
...
![Rolling Volatility](../figures/canonical_ml_showcase_v8/rolling_volatility.png)
...
![Feature Correlation Heatmap](../figures/canonical_ml_showcase_v8/feature_correlation_heatmap.png)
...
![Ml Feature Regimes](../figures/canonical_ml_showcase_v8/ml_feature_regimes.png)
...
![Feature Ic Heatmap](../figures/canonical_ml_showcase_v8/feature_ic_heatmap.png)
...
![Feature Family Ic](../figures/canonical_ml_showcase_v8/feature_family_ic.png)
...
![Portfolio Turnover](../figures/canonical_ml_showcase_v8/portfolio_turnover.png)
...
![Ml Ic Regime](../figures/canonical_ml_showcase_v8/ml_ic_regime.png)
...
![Ml Rolling Da](../figures/canonical_ml_showcase_v8/ml_rolling_da.png)
...
![Ml Residuals](../figures/canonical_ml_showcase_v8/ml_residuals.png)
...
![Ml Coefficient Stability](../figures/canonical_ml_showcase_v8/ml_coefficient_stability.png)
...
![Ml Coefficient Sign Heatmap](../figures/canonical_ml_showcase_v8/ml_coefficient_sign_heatmap.png)
...
![Feature Contribution Heatmap](../figures/canonical_ml_showcase_v8/feature_contribution_heatmap.png)
...
![Family Contribution Timeline](../figures/canonical_ml_showcase_v8/family_contribution_timeline.png)
...
![Ic By Vol Regime](../figures/canonical_ml_showcase_v8/ic_by_vol_regime.png)
...
![Equity And Drawdown](../figures/canonical_ml_showcase_v8/equity_and_drawdown.png)

*Max drawdown -34.1% — severe. Sharpe 0.62. Slow recovery indicates signal-edge loss, not random noise.*

![Rolling Sharpe](../figures/canonical_ml_showcase_v8/rolling_sharpe.png)
...
![Walk Forward Stitched](../figures/canonical_ml_showcase_v8/walk_forward_stitched.png)
...
![Walk Forward Timeline](../figures/canonical_ml_showcase_v8/walk_forward_timeline.png)
...
![Split Sharpes](../figures/canonical_ml_showcase_v8/split_sharpes.png)
...
![Train Vs Test Sharpe](../figures/canonical_ml_showcase_v8/train_vs_test_sharpe.png)
...
![Split Equity Curves](../figures/canonical_ml_showcase_v8/split_equity_curves.png)
...
![Ml Signal Turnover](../figures/canonical_ml_showcase_v8/ml_signal_turnover.png)
...
| Field | Value |
| --- | --- |
| Experiment | `canonical_ml_showcase_v8` |
| Strategy | `MLStrategy(Ridge(alpha=1.0))` |
| Created | 2026-06-06T15:35:27.167198+00:00 |
...
![Allocation History](../figures/canonical_ml_showcase_v8/allocation_history.png)
...
![Ml Information Coefficient](../figures/canonical_ml_showcase_v8/ml_information_coefficient.png)
...
![Ml Prediction Vs Actual](../figures/canonical_ml_showcase_v8/ml_prediction_vs_actual.png)
...
![Ml Prediction Distribution](../figures/canonical_ml_showcase_v8/ml_prediction_distribution.png)
...
![Ml Coefficient Evolution](../figures/canonical_ml_showcase_v8/ml_coefficient_evolution.png)
...
| Key | Value |
| --- | --- |
| ML hash | `0d4d8cfacc11` |

---

Report version: 1
Generated: 2026-06-06T15:35:35.611886+00:00
Source experiment: canonical_ml_showcase_v8