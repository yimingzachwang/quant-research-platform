# Experiment Report: canonical_ml_showcase_v3
...
![Cross Asset Volatility](../figures/canonical_ml_showcase_v3/cross_asset_volatility.png)
...
![Rolling Volatility](../figures/canonical_ml_showcase_v3/rolling_volatility.png)
...
![Feature Correlation Heatmap](../figures/canonical_ml_showcase_v3/feature_correlation_heatmap.png)
...
![Ml Feature Regimes](../figures/canonical_ml_showcase_v3/ml_feature_regimes.png)
...
![Feature Ic Heatmap](../figures/canonical_ml_showcase_v3/feature_ic_heatmap.png)
...
![Feature Family Ic](../figures/canonical_ml_showcase_v3/feature_family_ic.png)
...
![Portfolio Turnover](../figures/canonical_ml_showcase_v3/portfolio_turnover.png)
...
![Ml Ic Regime](../figures/canonical_ml_showcase_v3/ml_ic_regime.png)
...
![Ml Rolling Da](../figures/canonical_ml_showcase_v3/ml_rolling_da.png)
...
![Ml Residuals](../figures/canonical_ml_showcase_v3/ml_residuals.png)
...
![Ml Coefficient Stability](../figures/canonical_ml_showcase_v3/ml_coefficient_stability.png)
...
![Ml Coefficient Sign Heatmap](../figures/canonical_ml_showcase_v3/ml_coefficient_sign_heatmap.png)
...
![Feature Contribution Heatmap](../figures/canonical_ml_showcase_v3/feature_contribution_heatmap.png)
...
![Family Contribution Timeline](../figures/canonical_ml_showcase_v3/family_contribution_timeline.png)
...
![Ic By Vol Regime](../figures/canonical_ml_showcase_v3/ic_by_vol_regime.png)
...
![Equity And Drawdown](../figures/canonical_ml_showcase_v3/equity_and_drawdown.png)

*Max drawdown -34.1% — severe. Sharpe 0.67. Slow recovery indicates signal-edge loss, not random noise.*

![Rolling Sharpe](../figures/canonical_ml_showcase_v3/rolling_sharpe.png)
...
![Walk Forward Stitched](../figures/canonical_ml_showcase_v3/walk_forward_stitched.png)
...
![Walk Forward Timeline](../figures/canonical_ml_showcase_v3/walk_forward_timeline.png)
...
![Split Sharpes](../figures/canonical_ml_showcase_v3/split_sharpes.png)
...
![Train Vs Test Sharpe](../figures/canonical_ml_showcase_v3/train_vs_test_sharpe.png)
...
![Split Equity Curves](../figures/canonical_ml_showcase_v3/split_equity_curves.png)
...
![Ml Signal Turnover](../figures/canonical_ml_showcase_v3/ml_signal_turnover.png)
...
| Field | Value |
| --- | --- |
| Experiment | `canonical_ml_showcase_v3` |
| Strategy | `MLStrategy(Ridge(alpha=1.0))` |
| Created | 2026-06-06T12:55:51.634707+00:00 |
...
![Allocation History](../figures/canonical_ml_showcase_v3/allocation_history.png)
...
![Ml Information Coefficient](../figures/canonical_ml_showcase_v3/ml_information_coefficient.png)
...
![Ml Prediction Vs Actual](../figures/canonical_ml_showcase_v3/ml_prediction_vs_actual.png)
...
![Ml Prediction Distribution](../figures/canonical_ml_showcase_v3/ml_prediction_distribution.png)
...
![Ml Coefficient Evolution](../figures/canonical_ml_showcase_v3/ml_coefficient_evolution.png)
...
| Key | Value |
| --- | --- |
| ML hash | `922fd6d7b769` |

---

Report version: 1
Generated: 2026-06-06T12:56:00.444889+00:00
Source experiment: canonical_ml_showcase_v3